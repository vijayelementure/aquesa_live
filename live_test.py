...
@app.post('/watermeter')
def consumption():
    resp = dynamodb.execute_statement(Statement='SELECT * FROM aquesa_live WHERE P_key = ?', Parameters =[{'S':'8233b4c5-9f03-4038-bd24-78751032d569'}])
    # print(resp['Items'])
    sum = 0
